...
import RecommendationDeck from '../components/recommendations/RecommendationDeck';
...
export default function Home() {
  ...
  // src/pages/index.tsx - handleSubmit function update
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    // Fetch bar data first
    const barDataResult = await fetchBar(username);
    
    // If we successfully got bar data and there are bottles, get recommendations
    if (barDataResult && !barDataResult.userNotFound && barDataResult.bottles.length > 0) {
