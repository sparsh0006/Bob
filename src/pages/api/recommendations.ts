...
import { analyzeTasteProfile, generateRecommendations } from '../../services/recommendationEngine';
...
export default async function handler(
  ...
  try {
    ...
    // Step 2: Analyze user's taste profile
    const userProfile = analyzeTasteProfile(barData.bottles);
    
    // Step 3: Generate recommendations based on user's profile
    const recommendations = generateRecommendations(barData.bottles, userProfile);
